...
\subsubsection{Use-case 2: Điều phối lộ trình}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|l|X|}
\hline
...
\subsubsection{Use-case 3: Nhận lệnh vận chuyển}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|l|X|}
\hline
...
\subsubsection{Use-case 4: Cập nhật trạng thái vận chuyển}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|l|X|}
\hline
...
\subsubsection{Use-case 5: Giám sát vận chuyển}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|l|X|}
\hline
...
\subsubsection{Use-case 6: Phát hiện bất thường và gửi cảnh báo}
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|l|X|}
\hline

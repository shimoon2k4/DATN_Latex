...
Đặc thù của đạn dược là dễ cháy nổ và nhạy cảm với môi trường. Hệ thống được thiết kế để giám sát các rủi ro cụ thể sau:

\begin{itemize}
    \item \textbf{Rủi ro về nhiệt độ (Temperature Risk):} Nhiệt độ trong thùng xe tăng quá cao có thể kích hoạt thuốc phóng hoặc gây biến đổi tính chất hóa học của đạn dược. Ngưỡng cảnh báo thường được thiết lập ở mức $50^{\circ}C - 60^{\circ}C$.
    
    \item \textbf{Rủi ro về va đập, rung lắc (Vibration/Shock Risk):} Rung động mạnh do đường xấu hoặc va chạm giao thông có thể gây kích nổ đầu đạn hoặc hư hỏng cơ khí. Cảm biến gia tốc sẽ phát hiện các xung lực đột ngột (tính bằng G-force).
    
    \item \textbf{Rủi ro an ninh/Lộ trình (Security Risk):} Phương tiện đi sai lộ trình quy định, dừng đỗ quá lâu tại địa điểm lạ hoặc bị mất tín hiệu giám sát. Điều này cảnh báo nguy cơ bị phục kích, đánh cắp hoặc phá hoại.
    
    \item \textbf{Rủi ro độ ẩm (Humidity Risk):} Độ ẩm quá cao có thể gây ẩm mốc, làm hỏng ngòi nổ hoặc thuốc phóng, dẫn đến đạn bị lép hoặc nổ không hoàn toàn khi sử dụng.
\end{itemize}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/week/week_3/activity_dieuphoi.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/week/week_3/activity_quanly.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{images/week/week_3/activity_giamsat.png}

...
Thứ hai, \textbf{thiết kế khối thu thập dữ liệu} tích hợp đa cảm biến. Hệ thống sẽ sử dụng cảm biến DHT22 để giám sát nhiệt độ, độ ẩm; module Neo-6M cho định vị toạ độ GPS; và gia tốc kế ADXL345 nhằm phát hiện các va đập bất thường có thể ảnh hưởng đến an toàn của khí tài.

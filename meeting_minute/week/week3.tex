...
\subsection*{Mục tiêu}
Hoàn thiện 3 module đọc cảm biến trên ESP32 (GPS, DHT22, ADXL345), chuẩn hoá schema dữ liệu và ghi log ổn định để phục vụ các Epic xử lý \& truyền dữ liệu kế tiếp, đồng thời tổng hợp tài liệu kỹ thuật cho hệ thống.
...
\begin{itemize}
  ...
  \item \textbf{Task 2: Code đọc nhiệt độ/độ ẩm từ DHT22} — I\textsuperscript{2}C init, đọc \texttt{temp, hum}, kiểm tra CRC, retry/backoff khi lỗi.

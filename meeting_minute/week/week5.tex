...
& 17/10/2025 \\ 
\hline
Lọc nhiễu và chuẩn hoá dữ liệu cảm biến ADXL345 và DHT22 
& Hoàng Sỹ Xuân Sơn
& 17/10/2025 \\ 
\hline
...
\subsubsection{DHT22 (Nhiệt độ/Độ ẩm)}
\begin{itemize}
    \item \textbf{Phương pháp}: 
    Dữ liệu từ DHT22 vốn có tần số thấp và ít nhiễu, 
...
\subsection*{Đánh giá chung} Tuần này, nhóm đã hoàn thành tốt mục tiêu lọc nhiễu cho cảm biến ADXL345 và DHT22. Tuy nhiên, sự cố lớn nhất là module GPS không hoạt động vẫn chưa được giải quyết.

\subsection*{Kết quả đạt được (đã xác nhận)} 
\begin{itemize} 
\item \textbf{ADXL345/DHT22}: Dữ liệu được làm mượt và tăng độ tin cậy thông qua các bộ lọc phần mềm.
